...
class ExpeditionState(TypedDict):
    ...
    # Cross-Channel Correlation (NEW - Improvement #2)
    correlated_anomalies: list[dict]  # Anomalies occurring simultaneously across channels
    ...
    critic_retry_count: int  # NEW - Improvement #1: Track retry attempts
    critic_feedback: str | None  # NEW - Improvement #1: Feedback from critic to explainer on retry
    ...
    # Date Range (for time-travel analysis)
